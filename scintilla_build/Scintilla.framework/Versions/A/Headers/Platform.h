...
public:
  ...
  Font(Font &&other) noexcept : fid(other.fid) { other.fid = 0; }
...
public:
  ...
  virtual std::vector<Interval> FindRangeIntervals(size_t start,
                                                   size_t end) = 0;
};
...
public:
  ...
  Layout(const IScreenLine *screenLine) = 0;
  ...
  virtual void MeasureWidths(Font &font_, std::string_view text,
