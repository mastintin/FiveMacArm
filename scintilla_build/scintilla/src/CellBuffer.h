...
public:
  ...
  ~Action();
  void Create(actionType at_, Sci::Position position_ = 0,
              const char *data_ = nullptr, Sci::Position lenData_ = 0,
...
public:
  ...
  const char *AppendAction(actionType at, Sci::Position position,
                           const char *data, Sci::Position lengthData,
  ...
  // Tentative actions are used for input composition so that it can be undone
  // cleanly
  void TentativeStart();
...
private:
  ...
  void BasicInsertString(Sci::Position position, const char *s,
...
public:
  ...
  void GetCharRange(char *buffer, Sci::Position position,
  ...
  const char *InsertString(Sci::Position position, const char *s,
                           Sci::Position insertLength, bool &startSequence);
  ...
  bool SetStyleFor(Sci::Position position, Sci::Position lengthStyle,
                   char styleValue);

  const char *DeleteChars(Sci::Position position, Sci::Position deleteLength,
                          bool &startSequence);
