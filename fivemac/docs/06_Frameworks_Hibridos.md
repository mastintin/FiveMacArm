...
![Ejemplo Dashboard NiceGUI](img/cap5.png)
![Mando Apple Music (NiceGUI)](img/cap6.png)
*Ejecución híbrida: Cocoa (Ventana) + Swift (MusicKit) + NiceGUI (UI)*
...
![Ejemplo SwiftUI 1](img/cap1.png)
![Ejemplo SwiftUI 2](img/cap3.png)
