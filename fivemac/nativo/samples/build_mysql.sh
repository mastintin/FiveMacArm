...
clang $OBJS -o ./$APPName.app/Contents/MacOS/$APPName -target arm64-apple-macosx26.0 -L$CRTLIB -L./../lib -lfive -lfivec -L$HB_DIR/lib $HRBLIBS $FRAMEWORKS  -F./../../Resources/frameworks -framework Scintilla -lsqlite3 -L/opt/homebrew/Cellar/mariadb/12.1.2/lib -lmariadb -lssl -lcrypto $WINNH3DLIB $CRTLIB/libz.tbd $CRTLIB/libpcre.tbd
