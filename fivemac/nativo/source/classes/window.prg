...
CLASS TWindow
   ...
   METHOD SetResizable( lOnOff ) INLINE WndSetResizable( ::hWnd, lOnoff )   
...
METHOD HandleEvent( nMsg, nSender, uParam1, uParam2, uParam3, uParam4 ) CLASS TWindow
   ...
   if oControl != nil .and. oControl:bDropFiles != nil
   Eval( oControl:bDropFiles, uParam1 )
   elseif ::bDropFiles != nil
   Eval( ::bDropFiles, uParam1 )
   endif
   return nil
