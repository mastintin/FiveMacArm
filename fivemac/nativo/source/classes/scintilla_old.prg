...
#define SCE_FWH_DEFAULT 0
#define SCE_FWH_COMMENT 1
#define SCE_FWH_COMMENTLINE 2
#define SCE_FWH_COMMENTDOC 3
#define SCE_FWH_NUMBER 4      
#define SCE_FWH_STRING 5
#define SCE_FWH_OPERATOR 6
#define SCE_FWH_IDENTIFIER 7
#define SCE_FWH_KEYWORD 8
#define SCE_FWH_KEYWORD1 9
#define SCE_FWH_KEYWORD2 10
#define SCE_FWH_KEYWORD3 11
#define SCE_FWH_KEYWORD4 12
#define SCE_FWH_BRACE 13
...
CLASS TScintilla FROM TControl
   ...
   METHOD BraceMatch( nPos )                   INLINE SCISEND( ::hWnd, SCI_BRACEMATCH, nPos )
   ...
   METHOD GetCharAt( nPos ) INLINE SCISEND( ::hWnd, SCI_GETCHARAT, nPos )

   METHOD GetTextColor( cType )
   
   METHOD GetCurLine()
   
   METHOD GetCurrentLine()                   INLINE SCISEND( ::hWnd, SCI_LINEFROMPOSITION, ::GetCurrentPos() )
   METHOD GetCurrentPos()                    INLINE SCISEND( ::hWnd, SCI_GETCURRENTPOS )
   ...
   METHOD GetReadOnly()               INLINE SCISEND( ::hWnd, SCI_GETREADONLY ) != 0
...
function SelectScintillaTheme( oSci )
   ...
   if nSel > 0
      MAC_SETEDITORPRESET( oSci:hWnd, nSel )
   endif
return nil
