...
HB_FUNC(SHEETOPENRUN) {
  NSOpenPanel *panel = (NSOpenPanel *)hb_parnll(1);
...
HB_FUNC(SHEETSAVERUN) {
  ...
  NSSavePanel *panel = (NSSavePanel *)hb_parnll(1);
  NSWindow *window = (NSWindow *)hb_parnll(2);
  NSString *newName =
      [[[NSString alloc] initWithCString:HB_ISCHAR(3) ? hb_parc(3) : "nuevo"
...
HB_FUNC(SHEETSETTITLE) {
  NSPanel *panel = (NSPanel *)hb_parnll(1);
