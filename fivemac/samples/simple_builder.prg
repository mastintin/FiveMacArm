...
function GenerateHbp()
   ...
   cHbpContent += "-ldflag=Cocoa" + CRLF
   cHbpContent += "-ldflag=-framework" + CRLF
   cHbpContent += "-ldflag=WebKit" + CRLF
   cHbpContent += "-ldflag=-framework" + CRLF
   cHbpContent += "-ldflag=IOKit" + CRLF
   cHbpContent += "-ldflag=-framework" + CRLF
   cHbpContent += "-ldflag=ScreenCaptureKit" + CRLF
   cHbpContent += "-ldflag=-framework" + CRLF
   cHbpContent += "-ldflag=Scintilla" + CRLF
   cHbpContent += "-ldflag=-framework" + CRLF
   cHbpContent += "-ldflag=Quartz" + CRLF
   cHbpContent += "-ldflag=-framework" + CRLF
   cHbpContent += "-ldflag=CoreImage" + CRLF
   cHbpContent += "-ldflag=-framework" + CRLF
   cHbpContent += "-ldflag=UserNotifications" + CRLF
   cHbpContent += "-ldflag=-framework" + CRLF
   cHbpContent += "-ldflag=ScriptingBridge" + CRLF
   cHbpContent += "-ldflag=-framework" + CRLF
   cHbpContent += "-ldflag=AVKit" + CRLF
   cHbpContent += "-ldflag=-framework" + CRLF
   cHbpContent += "-ldflag=AVFoundation" + CRLF
   cHbpContent += "-ldflag=-framework" + CRLF
   cHbpContent += "-ldflag=CoreMedia" + CRLF
   cHbpContent += "-ldflag=-framework" + CRLF
   cHbpContent += "-ldflag=UniformTypeIdentifiers" + CRLF
