...
public class StackItem: Identifiable {
    public enum ItemType: Int, Codable {
        case text = 0, vstack = 1, hstack = 2, scroll = 3, image = 4, spacer = 5, divider = 6, list = 8, button = 9, toggle = 10, slider = 11, webview = 12, progress = 13, get = 14, datepicker = 15, grid = 16, aichat = 17, picker = 18, card = 19, panel = 20, sidebar = 21, sidebaritem = 22, tabview = 23, zstack = 24, menu = 25, menuitem = 26, browse = 27, quicklook = 28, map = 29, stepper = 30, colorpicker = 31, gauge = 32, header = 33
    }
...
public class SwiftVStackState: StackStateProtocol, RGBAColorableState, SwApplyable {
    ...
    public func apply(property: String, value: Any) {
        ...
        } else if prop == "isglass" || prop == "glass" {
            self.isGlass = SwUtils.toBool(value)
        }
    }
}
