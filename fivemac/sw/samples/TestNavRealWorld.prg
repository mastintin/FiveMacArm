...
function AppMain()
   ...
   if ! Empty( aUsers )
      for nU := 1 to Len( aUsers )
         ...
         // Tarjeta 1
         @ 0, 0 CARD oCard1 TITLE "Datos Personales" SYMBOL "person.text.rectangle" OF oVStack SIZE 440, 580
         oCard1:lGlass := .T.
         oCard1:nPadding := 0
         oCard1:nSpacing := 24
         ...
         @ 0,0 VSTACK oV1 OF oCard1
         oV1:nSpacing := 15   
         ov1:nPadding := 1

         @ 0, 0 SAY "Cálculo de la Jubilación" OF oV1 SIZE 440, 32 ;
            ICON "timer" ;
            ICONSIZE 32 ; 
            FONT ".title1.bold" ;
            COLOR ".primary"

         @ 0, 0 HSTACK oHData OF oV1
         oHData:nSpacing := 24
