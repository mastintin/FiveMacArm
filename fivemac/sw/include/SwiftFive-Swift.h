...
SWIFT_EXTERN void HB_FUN_SW_BUTTON_CREATE(void * _Nullable p) SWIFT_NOEXCEPT;

SWIFT_EXTERN void HB_FUN_SW_BUTTON_SETCOLOR(void * _Nullable p) SWIFT_NOEXCEPT;

SWIFT_EXTERN void HB_FUN_SW_BUTTON_SETCORNER(void * _Nullable p) SWIFT_NOEXCEPT;

SWIFT_EXTERN void HB_FUN_SW_BUTTON_SETTEXT(void * _Nullable p) SWIFT_NOEXCEPT;

SWIFT_EXTERN void * _Nullable HB_FUN_SW_CREATEWINDOW(void * _Nullable p) SWIFT_NOEXCEPT SWIFT_WARN_UNUSED_RESULT;

SWIFT_EXTERN void HB_FUN_SW_GET_PROXY_MAP(void * _Nullable p) SWIFT_NOEXCEPT;

SWIFT_EXTERN void HB_FUN_SW_LABEL_CREATE(void * _Nullable p) SWIFT_NOEXCEPT;

SWIFT_EXTERN void HB_FUN_SW_MSGINFO(void * _Nullable p) SWIFT_NOEXCEPT;
...
SWIFT_EXTERN void HB_FUN_SW_WEBVIEW_CREATE(void * _Nullable p) SWIFT_NOEXCEPT;
