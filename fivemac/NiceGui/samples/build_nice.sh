# ./build_nice.sh
# Syntax: ./build_nice.sh <prg_file_without_extension>

if [ -z "$1" ]; then
  echo "Syntax: ./build_nice.sh <file>"
  exit 1
fi
...
# 10b. Formatters Native (ObjC) - Needed for FMDateFormatter
clang -ObjC "../../nativo/source/winapi/formatters.m" -c -o obj/formatters_mod.o -I../../nativo/include -I../../../harbour/include
...
# Link against libSwiftFive.a from SwiftUI/lib
clang obj/$NAME.o \
    obj/NiceCore_mod.o obj/NiceChart_mod.o obj/NiceControls_mod.o obj/NiceLayout_mod.o obj/NicePrinter_mod.o obj/NiceTable_mod.o \
    obj/webview_mod.o obj/webviews_mod.o \
    obj/sqlite_mod.o obj/sqlite_c_mod.o obj/formatters_mod.o \
    -o $NAME \
    -Wl,-force_load,../../SwiftUI/lib/libSwiftFive.a \
    -L../../nativo/lib -lfive -lfivec \
    -L../../SwiftUI/lib -lSwiftFive \
    -L../../../harbour/lib $HRBLIBS \
    $FRAMEWORKS \
    -F../../Resources/frameworks -framework Scintilla \
    -lsqlite3 \
    $CRTLIB/libz.tbd $CRTLIB/libpcre.tbd \
    -rpath @executable_path/../../Resources/frameworks
