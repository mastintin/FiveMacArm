...
# 2. Build the Library First (Ensure it's up to date with new SwiftImage changes)
...
echo "Compiling App..."
"$HARBOUR_PATH/bin/harbour" TestSwiftImage.prg -n -w -I"SwiftFive/include" -I"$FIVEMAC_PATH/include" -I"$HARBOUR_PATH/include"

if [ $? -ne 0 ]; then echo "Error compiling Harbour App"; exit 1; fi

echo "Compiling C generated by Harbour..."
clang -c TestSwiftImage.c \
