...
# 3. Compile App (SimpleTest.prg)
echo "Compiling App..."
"$HARBOUR_PATH/bin/harbour" testswiftpicker.prg -n -w -I"SwiftFive/include" -I"$FIVEMAC_PATH/include" -I"$HARBOUR_PATH/include"

if [ $? -ne 0 ]; then echo "Error compiling Harbour App"; exit 1; fi

echo "Compiling C generated by Harbour..."
clang -c testswiftpicker.c \
