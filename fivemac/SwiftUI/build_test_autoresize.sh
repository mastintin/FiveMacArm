...
# 3. Compile App (TestAutoResize.prg)
echo "Compiling App..."
"$HARBOUR_PATH/bin/harbour" TestAutoResize.prg -n -w -I"SwiftFive/include" -I"$FIVEMAC_PATH/include" -I"$HARBOUR_PATH/include"

if [ $? -ne 0 ]; then echo "Error compiling Harbour App"; exit 1; fi

echo "Compiling C generated by Harbour..."
clang -c TestAutoResize.c \
...
chmod +x build_test_autoresize.sh
