...
# 3. Compile App (TestSwiftList.prg)
echo "Compiling App..."
"$HARBOUR_PATH/bin/harbour" TestSwiftList.prg -n -w -I"SwiftFive/include" -I"$FIVEMAC_PATH/include" -I"$HARBOUR_PATH/include"

if [ $? -ne 0 ]; then echo "Error compiling Harbour App"; exit 1; fi

echo "Compiling C generated by Harbour..."
clang -c TestSwiftList.c \
