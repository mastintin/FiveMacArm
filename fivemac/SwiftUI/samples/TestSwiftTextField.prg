...
function Main()
    ...
    oGet1 := TSwiftTextField():New( 50, 20, 360, 24, cText1, "Type something...", oWnd, ;
        {|cValue| If( oSay1 != nil, oSay1:SetText( "Value 1: " + cValue ), ) } )
    ...
    oGet2 := TSwiftTextField():New( 110, 20, 360, 24, cText2, "Password or more text...", oWnd, ;
        {|cValue| If( oSay2 != nil, oSay2:SetText( "Value 2: " + cValue ), ) } )

    @ 140, 20 SAY oSay2 PROMPT "Value 2: " + cText2 SIZE 360, 20 OF oWnd
   
    @ 180, 20 BUTTON "Set Text 1" SIZE 100, 30 OF oWnd ACTION ( oGet1:Value := "Hi #1!" )
    @ 180, 130 BUTTON "Get Text 1" SIZE 100, 30 OF oWnd ACTION ( MsgInfo( "Get 1: '" + oGet1:Value + "'" ) )

    @ 220, 20 BUTTON "Set Text 2" SIZE 100, 30 OF oWnd ACTION ( oGet2:Value := "Hi #2!" )
    @ 220, 130 BUTTON "Get Text 2" SIZE 100, 30 OF oWnd ACTION ( MsgInfo( "Get 2: '" + oGet2:Value + "'" ) )
