...
# 3. Compile App (SimpleStandalone.prg)
echo "Compiling App..."
"$HARBOUR_PATH/bin/harbour" TestSwiftGet.prg -n -w -p -I"SwiftFive/include" -I"$FIVEMAC_PATH/nativo/include" -I"$HARBOUR_PATH/include"

if [ $? -ne 0 ]; then echo "Error compiling Harbour App"; exit 1; fi

echo "Compiling C generated by Harbour..."
clang -c TestSwiftGet.c \
