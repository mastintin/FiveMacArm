...
CLASS TWBrowse FROM TControl
   ...
   METHOD SetSystemFont( nSize ) INLINE BRWSETSYSTEMFONT(::hwnd, nSize )
   
   METHOD SetmenuFont( nSize ) INLINE BRWSETMENUFONT(::hWnd,nSize )
   ...
   METHOD ClrDblClick() INLINE BrwClrDblAction( ::hWnd )
   
   METHOD Edit( nCol ) INLINE BrwEdit( ::hWnd, nCol )
