...
- (void)flipCellsWithOldSelectedIndex:(unsigned int)fp8
                     newSelectedIndex:(unsigned int)fp12;
...
- (id)backgroundColor;
- (void)_setBackgroundColorWithRed:(float)fp8
                             green:(float)fp12
                              blue:(float)fp16
                             alpha:(float)fp20;
- (BOOL)backgroundIsLight;
- (BOOL)backgroundIsBlack;
- (BOOL)_convertColor:(id)fp8
                toRed:(float *)fp12
                green:(float *)fp16
                 blue:(float *)fp20
                alpha:(float *)fp24;
- (void)_getBackgroundRed:(float *)fp8
                    green:(float *)fp12
                     blue:(float *)fp16
                    alpha:(float *)fp20;
...
- (void)setupGLState;
//- (void)installPerspetiveViewportForPicking:(BOOL)fp8 location:(struct
//_NSPoint)fp12;
...
- (void)__copyPixels:(void *)fp8
                       withSize:(struct _NSSize)fp12
    toCurrentFocusedViewAtPoint:(NSPoint)fp20;
//- (void)__copyPixels:(void *)fp8 withSize:(struct _NSSize)fp12
// toCurrentFocusedViewAtPoint:(struct _NSPoint)fp20;
...
#if __MAC_OS_X_VERSION_MAX_ALLOWED < 1050
- (id)imageFlow:(IKBImageFlowView *)aBrowser
...
- (void)addImagesFromDirectory:(NSString *)path {
  ...
  if (dir) {
    ...
    for (i = 0; i < n; i++)
      [self addImageWithPath:[path stringByAppendingPathComponent:
...
HB_FUNC(IKCOVERCREATE) {
  ...
  IKBImageFlowView *vista = [[IKBImageFlowView alloc]
...
HB_FUNC(IKCOVERINICIAL) {
  IKBImageFlowView *vista = (IKBImageFlowView *)hb_parnll(1);
  [vista inicial];
}
