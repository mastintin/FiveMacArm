...
HB_FUNC(TBRSEARCHCREATE) {
  ...
  if ([edit respondsToSelector:@selector(doSearch:)]) {
    [[[edit cell] searchButtonCell] setTarget:edit];
    [[[edit cell] searchButtonCell] setAction:@selector(doSearch:)];

    [edit setTarget:edit];
    [edit setAction:@selector(doSearch:)];
  }
