...
HB_FUNC(CLRRED) { hb_retnl((HB_LONG)[NSColor redColor]); }

HB_FUNC(CLRGREEN) { hb_retnl((HB_LONG)[NSColor greenColor]); }

HB_FUNC(CLRBLUE) { hb_retnl((HB_LONG)[NSColor blueColor]); }

HB_FUNC(COLOR_SET) { [((NSColor *)hb_parnl(1)) set]; }
