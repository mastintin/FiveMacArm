...
HB_FUNC(SEGMENTSETIMAGE) {
  ...
  [segment setImage:[[NSImage alloc] initWithContentsOfFile:string]
         forSegment:hb_parnl(3)];
}

HB_FUNC(SEGMENTSETIMAGESCALING) {
  NSSegmentedControl *segment = (NSSegmentedControl *)hb_parnll(1);
  [segment setImageScaling:NSImageScaleProportionallyDown
