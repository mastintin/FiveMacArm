 ...
 * Generated C source from "hbnf/bytexor.prg"
 */
...
HB_INIT_SYMBOLS_BEGIN( hb_vm_SymbolInit_BYTEXOR )
{ "FT_BYTEXOR", {HB_FS_PUBLIC | HB_FS_LOCAL}, {HB_FUNCNAME( FT_BYTEXOR )}, NULL },
...
HB_INIT_SYMBOLS_EX_END( hb_vm_SymbolInit_BYTEXOR, "hbnf/bytexor.prg", 0x0, 0x0003 )

#if defined( HB_PRAGMA_STARTUP )
   #pragma startup hb_vm_SymbolInit_BYTEXOR
#elif defined( HB_DATASEG_STARTUP )
   #define HB_DATASEG_BODY    HB_DATASEG_FUNC( hb_vm_SymbolInit_BYTEXOR )
   #include "hbiniseg.h"
#endif
