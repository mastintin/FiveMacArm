 ...
 * Generated C source from "hbnf/acctqtr.prg"
 */
...
HB_INIT_SYMBOLS_BEGIN( hb_vm_SymbolInit_ACCTQTR )
{ "FT_ACCTQTR", {HB_FS_PUBLIC | HB_FS_LOCAL}, {HB_FUNCNAME( FT_ACCTQTR )}, NULL },
...
HB_INIT_SYMBOLS_EX_END( hb_vm_SymbolInit_ACCTQTR, "hbnf/acctqtr.prg", 0x0, 0x0003 )

#if defined( HB_PRAGMA_STARTUP )
   #pragma startup hb_vm_SymbolInit_ACCTQTR
#elif defined( HB_DATASEG_STARTUP )
   #define HB_DATASEG_BODY    HB_DATASEG_FUNC( hb_vm_SymbolInit_ACCTQTR )
   #include "hbiniseg.h"
#endif
...
HB_FUNC( FT_ACCTQTR )
{
	static const HB_BYTE pcode[] =
	{
		...
		95,4,121,8,28,10,126,3,255,255,92,4,80,4,
		...
		95,1,12,1,80,5,126,4,1,0,95,4,92,5,
		...
		95,2,92,4,15,28,6,92,4,80,2,176,4,0,
