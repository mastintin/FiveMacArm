...
HB_FUNC_EXTERN( SQLITE3_DB_FILENAME );
...
HB_FUNC_EXTERN( SQLITE3_EXPANDED_SQL );
...
HB_FUNC_EXTERN( SQLITE3_STATUS64 );
...
HB_FUNC_EXTERN( SQLITE3_TRACE_V2 );
...
{ "SQLITE3_DB_FILENAME", {HB_FS_PUBLIC}, {HB_FUNCNAME( SQLITE3_DB_FILENAME )}, NULL },
...
{ "SQLITE3_EXPANDED_SQL", {HB_FS_PUBLIC}, {HB_FUNCNAME( SQLITE3_EXPANDED_SQL )}, NULL },
...
{ "SQLITE3_STATUS64", {HB_FS_PUBLIC}, {HB_FUNCNAME( SQLITE3_STATUS64 )}, NULL },
...
{ "SQLITE3_TRACE_V2", {HB_FS_PUBLIC}, {HB_FUNCNAME( SQLITE3_TRACE_V2 )}, NULL },
