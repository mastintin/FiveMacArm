...
HB_FUNC( XPP_DBUSEAREA )
{
	static const HB_BYTE pcode[] =
	{
		13,2,6,176,4,0,95,1,12,1,28,79,95,1,
		28,75,176,5,0,96,4,0,106,1,0,20,2,176,
		6,0,95,4,12,1,28,6,95,3,80,4,176,7,
		0,95,4,12,1,28,42,85,80,7,176,8,0,95,
		4,12,1,165,80,8,121,15,28,18,96,4,0,106,
		2,95,0,176,9,0,95,8,12,1,72,135,176,10,
		0,95,7,20,1,176,11,0,95,1,95,2,95,3,
		95,4,95,5,95,6,20,6,7
	};
